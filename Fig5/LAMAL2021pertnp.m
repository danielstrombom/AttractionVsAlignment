function M = LAMAL2021pertnp(N,R,delta,L,a,c,t)

%LAM + explicit alignment (if c=0 only explicit alignment).
...
%a = relative tendency to align with neighbors
...
%     end
   ...
   for i=1:N %Update each particle
        ...
        CMAL=nh2DL(i,P,R,L,0); 
        
        C=CMAL(1,:); % Direction toward the LCM
        A=CMAL(2,:); % Direction of alignment
