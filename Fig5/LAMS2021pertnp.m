function M = LAMS2021pertnp(N,Na,R,delta,L,T,c)

    %2D local attraction model with periodic boundary conditions and
    %Na particles using Asynchronous, and N-Na use Synchronous, heading/position updates.
    ...
    % L=20 side length of square w periodic bc
