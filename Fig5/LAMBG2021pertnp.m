function X = LAMBG2021pertnp(N,R,delta,L,c,T)

%Function to simulate repolarization behavior of Burst-and-glide LAM
...
%    end
       ...
       for i=1:N % 
            ...
            if P(i,4)<k %if update heading in this time step
                ...
                PP(i,5)=delta*exp(1*(P(i,6)-k)); %speed in this ts %THIS LINE
