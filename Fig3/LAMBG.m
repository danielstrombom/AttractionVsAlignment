function X = LAMBG(N,R,delta,L,c,T)

%Function to simulate the burst-and-glide asynchronous LAM (Strömbom &
%Tulevech). 
...
%    end
       ...
       for i=1:N % 
            ...
            if P(i,4)<k %if update heading in this time step
                ...
                PP(i,5)=delta*exp(0.5*(P(i,6)-k)); %speed in this ts %THIS LINE
